...
export default function Page() {
    ...
    return (
        ...
        <div className="grid grid-cols-3 gap-5 h-48 p-6">
            ...
            <div onClick={handleOnClick} className="rounded-lg border h-44 border-zinc-100 bg-gradient-to-r from-gray-100 to-gray-50 p-6 shadow-md hover:shadow-lg transition-all duration-500 ease-in-out transform hover:scale-105 flex flex-col justify-center items-center cursor-pointer">
